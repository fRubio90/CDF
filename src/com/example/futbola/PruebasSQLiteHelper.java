...
public class PruebasSQLiteHelper extends SQLiteOpenHelper {

	//Sentencia SQL para crear la tabla de Usuarios
    
	String sqlCreate = "CREATE TABLE Pruebas (Codigo INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,Nombre TEXT, Categoria INTEGER)";
 
    public PruebasSQLiteHelper(Context contexto, String nombre,
